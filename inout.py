...
def load_mnist():
    ...
    f_x_train = os.path.join(os.path.dirname(__file__), 'MNIST_data/train-images.idx3-ubyte')
    f_lable_train = os.path.join(os.path.dirname(__file__), 'MNIST_data/train-labels.idx1-ubyte')
    f_x_test = os.path.join(os.path.dirname(__file__), 'MNIST_data/t10k-images.idx3-ubyte')
    f_lable_test = os.path.join(os.path.dirname(__file__), 'MNIST_data/t10k-labels.idx1-ubyte')

    X_train = idx2numpy.convert_from_file(f_x_train)
    train_labels = idx2numpy.convert_from_file(f_lable_train)
    X_test = idx2numpy.convert_from_file(f_x_test)
    test_labels = idx2numpy.convert_from_file(f_lable_test)
