...
for index_folder_name in range(len(folder_name)):
    ...
    line_lable_loss="{0}".format(folder_name[index_folder_name])
    ...
    plt.xticks(range(0,len(val_loss[index_folder_name]),2))
    plt.legend()
...
for index_folder_name in range(len(folder_name)):
    line_lable_acc="{0}".format(folder_name[index_folder_name])
